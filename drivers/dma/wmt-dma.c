...
/*
 * wmt_dma_free_chan_resources - Free virt-dma channel resources
 */
...
/*
 * wmt_dma_device_config - Record the peripheral channel configuration
 */
...
/*
 * wmt_dma_free_desc - Free a descriptor and its pool block
 */
...
/*
 * wmt_dma_start_desc - Program and start the active descriptor
 */
...
/*
 * wmt_dma_start_next - Dequeue and start the next transfer (caller holds the vchan lock)
 */
...
/*
 * wmt_dma_get_ccr - Build the CCR value for peripheral transfers
 */
...
/*
 * wmt_dma_prep_dma_cyclic - Prepare a cyclic descriptor ring
 */
...
/*
 * wmt_dma_prep_slave_sg - Prepare a peripheral scatter-gather descriptor chain
 */
...
/*
 * wmt_dma_prep_dma_memcpy - Prepare a memory-to-memory descriptor chain pair
 */
...
/*
 * wmt_dma_terminate_all - Stop the channel and free every descriptor
 */
...
/*
 * wmt_dma_synchronize - Wait out the interrupt handler and descriptor callbacks
 */
...
/*
 * wmt_dma_tx_status - Report transfer status and residue
 */
...
/*
 * wmt_dma_interrupt - Per-channel interrupt handler
 */
...
/*
 * wmt_dma_xlate - Bind a devicetree request ID to a free channel
 */
...
static int wmt_dma_probe(struct platform_device *pdev)
{
	...
	/* Unmask channel interrupts now that all handlers are in place */
