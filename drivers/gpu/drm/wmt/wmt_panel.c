...
/*
 * wmt_panel_parse - Build a mode from a vendor lcdparam string
 */
...
/*
 * wmt_panel_prepare - Power the panel up
 */
...
/*
 * wmt_panel_unprepare - Power the panel down
 */
...
/*
 * wmt_panel_get_modes - Hand the panel mode to the connector
 */
...
/*
 * wmt_panel_probe - Platform device probe
 */
...
/*
 * wmt_panel_remove - Platform device remove
 */
