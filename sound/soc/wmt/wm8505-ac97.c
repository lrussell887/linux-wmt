			    ...
			    struct snd_kcontrol *k, int event)
{
	...
	unsigned short reg = wm8505_ac97_read(NULL, VT1613_CTRL);

	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		wm8505_ac97_write(NULL, VT1613_CTRL, reg & ~VT1613_CTRL_AMP3941_DIS);
			   ...
			   struct snd_kcontrol *k, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		wm8505_ac97_write(NULL, VT1613_CTRL, reg & ~VT1613_CTRL_AMP3536_DIS);
		break;
	case SND_SOC_DAPM_PRE_PMD:
		wm8505_ac97_write(NULL, VT1613_CTRL, reg | VT1613_CTRL_AMP3536_DIS);
		break;
...
static int wm8505_ac97_machine_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	reg = wm8505_ac97_read(NULL, VT1613_TEST);
	wm8505_ac97_write(NULL, VT1613_TEST, reg | VT1613_TEST_DCOR);
	reg = wm8505_ac97_read(NULL, VT1613_CTRL);
	wm8505_ac97_write(NULL, VT1613_CTRL, reg & ~VT1613_CTRL_SMUTE_DIS);
